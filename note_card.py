...
class NoteCard(QFrame):
    def __init__(self, title, remind_at, remind_at2, on_view_clicked, on_delete_clicked):
        ...
        self.view_btn.setIcon(QIcon(resource_path("images", "icons", "cil-pencil.png")))
        self.back_btn.setIcon(QIcon(resource_path("images", "icons", "cil-chevron-circle-left-alt.png")))
